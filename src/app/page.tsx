export default function Page() {  
  return (
    <>
      <div style={{ backgroundColor: '#D3D3D3', padding: '20px', height: '100vh' }}>
        <h1 className="text-3xl text-center text-black mb-10">Final Exam: New Orleans Saints Ticket Box</h1>
        <form className="max-w-4xl mx-auto mt-10 bg-blue-50 p-8 rounded-lg shadow-lg"> {/* Changed background and made the form wider */}
